...
const COMMON_KEYS: KeySpec[] = [
  ...
  { field: 'zhenzhenSd2ApiKey', label: '贞贞的平价AI工坊（国内） API Key', desc: '· 主力 API · 用于 Seedance 2.0、Happy Horse、Hailuo、Kling、Vidu、Upscaler、Seedream、Zhenzhen Image G-2 与 Seed Audio', bullet: 'bg-lime-400' },
