...
- The authorized v2.7.7 flow produced exactly one actual Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.7.7.exe` is 1,304,750,175 bytes with SHA-256 `d92b75b9f8613f54dd51a12aeb8f8da8ef68d93ae2690b96f9ef8a49f4249ddd`; its blockmap is 1,359,687 bytes with SHA-256 `d8dbf3e44cb34a6e52c40263c101601849e2be35b6f92df34ba3a02e5c866502`; `latest.yml` is 362 bytes with SHA-256 `4d326aad3da5398e8315aad08dc82b5fb80516c995462788f26fdc160641f1c1`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full remote re-download, final Latest verification, and recovery cleanup passed.
