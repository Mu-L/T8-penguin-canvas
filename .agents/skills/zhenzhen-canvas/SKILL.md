...
- The current released desktop and automatic-update baseline is `v2.8.6`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.6>. It is published, non-draft, non-prerelease, and GitHub Latest.
- Its fixed `v2.8.6` release Tag and Release target point to packaged-source commit `320adfed895ae728a373d172e6d374497e902675`. Later metadata-only commits on `main` must not move that Tag.
...
- The v2.8.6 flow produced one final Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.6.exe` is 1,317,591,958 bytes with SHA-256 `1f728fa0288880077889fb8d30b63957e8f97d016c72606e7952a6ef07ff54bd`; its blockmap is 1,372,853 bytes with SHA-256 `324fe5e357b28b6d9357f803862ee198bbd86df228326dbfcf34b184dfd071d5`; `latest.yml` is 362 bytes with SHA-256 `33e91be08d378fe34d7b1e551f153d4900424239035780f5eee0c6fcd6809edf`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
- Affected-user installation, multi-device collaboration, installed-upgrade, and remaining live Provider quality evidence remains explicitly deferred under `owner-approved-post-release-v2.8.6` and must never be reported as passed before it exists.
