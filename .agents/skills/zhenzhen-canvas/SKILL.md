...
- The current released desktop and automatic-update baseline is `v2.8.5`: <https://github.com/T8mars/T8-penguin-canvas/releases/tag/v2.8.5>. It is published, non-prerelease, and GitHub Latest until the authorized v2.8.6 flow converges.
- Its fixed `v2.8.5` release Tag and Release target point to packaged-source commit `bbe4500407a45b66c8407180ffc142dcd1d4b962`. Later metadata-only commits on `main` must not move that Tag.
...
- The authorized v2.8.5 flow produced exactly one final Electron/NSIS artifact set. Installer `T8-PenguinCanvas-Setup-2.8.5.exe` is 1,317,585,429 bytes with SHA-256 `e47b6b2ccf99d772f0b5e2be02e8e055d5c49cbcf866e72b54b79abaf011a3d2`; its blockmap is 1,373,164 bytes with SHA-256 `d4eb018cb972595d0acdce002547de414e256c455ff5e2990d41b716af7534f5`; `latest.yml` is 362 bytes with SHA-256 `9b31c8a4fe3021ca19a38779d3737332431049deb47c42952a2548bf3700afd6`. Post-build, provenance, sealed recovery, GitHub digest/size metadata, full prepublish and independent postpublish remote downloads, final Latest verification, and recovery cleanup passed.
- Affected-user installation, multi-device collaboration, installed-upgrade, and full live Provider quality evidence remains explicitly deferred under `owner-approved-post-release-v2.8.5` and must never be reported as passed before it exists.
